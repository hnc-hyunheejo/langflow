...
class TestOpenDataLoaderPDFComponent(ComponentTestBaseWithoutClient):
    ...
    def test_content_safety_disabled_custom_filters(
    ...
    def test_java_check_success(self, component_class, default_kwargs):
        ...
        with patch("subprocess.run") as mock_run:
            mock_run.return_value = Mock(
                returncode=0, stderr='openjdk version "11.0.1"'
            )
            component = component_class()
            component.set_attributes(default_kwargs)
    ...
    @patch.object(
        OpenDataLoaderPDFComponent, "_check_java_installed", return_value=True
    )
    ...
    @patch.object(
        OpenDataLoaderPDFComponent, "_check_java_installed", return_value=False
    )
    def test_java_not_installed_error(
        self, _mock_java_check, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_hybrid_url_option(self, component_class, default_kwargs):
        ...
        component.set_attributes(
            {**default_kwargs, "hybrid_url": "http://localhost:5002"}
        )
    ...
    def test_process_files_with_all_options(
        self, _mock_java_check, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_process_files_hybrid_on_empty_url_excludes_url(
        ...
        assert (
            len(hybrid_logs) == 1
        ), f"Expected one hybrid config log, got: {log_messages}"
    ...
    def test_process_files_hybrid_logs_custom_url(
        self, _mock_java_check, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_process_files_pdf_format_base64(
        self, _mock_java_check, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_get_tool_description_multiple_files(self, component_class, default_kwargs):
        ...
        component = component_class()
        component.set_attributes(
            {**default_kwargs, "path": ["flow123/a.pdf", "flow123/b.pdf"]}
        )
        desc = component.get_tool_description()
    ...
    @pytest.mark.asyncio
    async def test_get_tools_description_includes_filenames(
        self, component_class, default_kwargs
    ):
        """Test that both tools' descriptions include uploaded file names."""
        component = component_class()
        component.set_attributes(
            {**default_kwargs, "path": ["flow123/important_report.pdf"]}
        )
        tools = await component._get_tools()
        assert len(tools) == 2
    ...
    def test_output_dir_used_instead_of_temp(
        self, _mock_java_check, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_process_files_multiple_pdfs(
        self, _mock_java_check, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_temp_dirs_cleaned_up_after_processing(
        self, _mock_java_check, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_temp_dirs_cleaned_up_on_exception(
        self, _mock_java_check, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_parse_pages_from_json_data(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_parse_pages_from_json_empty_kids(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_parse_pages_from_sentinel_text(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_parse_pages_no_sentinel_single_page(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_parse_pages_pdf_format_skipped(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_data_metadata_json_format_total_pages(
        self, _mock_java_check, component_class, default_kwargs, tmp_path
    ):
            ...
            content = json.dumps(
                {
                    ...
                    "number of pages": 5,
                    "kids": [
                        {"type": "paragraph", "page number": 1, "content": "Hello"}
                    ],
                }
            )
    ...
    def test_sentinel_injected_for_text_format(
        self, _mock_java_check, component_class, default_kwargs, tmp_path
    ):
        ...
        component = component_class()
        component.set_attributes(
            {**default_kwargs, "format": "text", "text_page_separator": ""}
        )
        component.log = Mock()
    ...
    def test_sentinel_not_injected_for_json_format(
        self, _mock_java_check, component_class, default_kwargs, tmp_path
    ):
        ...
        for key in [
            ...
            assert key not in call_args or "ODL_PAGE_BREAK" not in str(
                call_args.get(key, "")
            )

    # --- Tests for _file_path_as_list Message.files handling ---

    def test_file_path_as_list_message_with_files(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_file_path_as_list_message_with_multiple_files(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_file_path_as_list_message_empty_files_falls_back_to_text(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_file_path_as_list_message_list_with_files(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_cached_data_calls_load_files_base_once(
        self, component_class, default_kwargs, tmp_path
    ):
        ...
        with patch.object(
            component, "load_files_base", return_value=mock_data
        ) as mock_load:
    ...
    def test_load_files_uses_cache(self, component_class, default_kwargs, tmp_path):
        ...
        pdf_file = str(tmp_path / "test.pdf")
        mock_data = [
            Data(data={"text": "content", "file_path": pdf_file, "format": "text"})
        ]
        with patch.object(
            component, "_get_cached_data", return_value=mock_data
        ) as mock_cache:
    ...
    def test_load_files_message_uses_cache(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_load_files_by_page_returns_dataframe(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_hybrid_timeout_none_excluded(
        self, _mock_java_check, component_class, default_kwargs, tmp_path
    ):
        """Test that hybrid_timeout is excluded from convert_params when it is None."""
        pdf_file = tmp_path / "test.pdf"
        pdf_file.write_bytes(b"%PDF-1.4 mock content")
        ...
        call_args = convert_calls[0]
        assert call_args["hybrid"] == "docling-fast"
        # hybrid_timeout should NOT be present when value is None
        assert "hybrid_timeout" not in call_args
    ...
    def test_hybrid_convert_failure_with_fallback_enabled(
        ...
        mock_opendataloader = MagicMock()
        mock_opendataloader.convert.side_effect = RuntimeError(
            "Connection to hybrid backend refused"
        )
        ...
        error_logs = [
            str(call)
            for call in component.log.call_args_list
    ...
    def test_hybrid_no_log_when_hybrid_off(
        self, _mock_java_check, component_class, default_kwargs, tmp_path
    ):
        ...
        assert (
            len(hybrid_logs) == 0
        ), f"Unexpected hybrid log when hybrid is off: {hybrid_logs}"

    @patch.object(
        OpenDataLoaderPDFComponent, "_check_java_installed", return_value=True
    )
    def test_hybrid_with_markdown_format(
        self, _mock_java_check, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_content_safety_disabled_empty_filters_defaults_to_all(
        self, component_class, default_kwargs
    ):
    ...
    def test_content_safety_disabled_whitespace_only_filters_defaults_to_all(
        self, component_class, default_kwargs
    ):
    ...
    def test_count_total_pages_json_with_parsed_json(
        self, component_class, default_kwargs
    ):
    ...
    def test_count_total_pages_json_parsed_json_missing_field(
        self, component_class, default_kwargs
    ):
    ...
    def test_count_total_pages_json_missing_field(
        self, component_class, default_kwargs
    ):
    ...
    def test_count_total_pages_text_with_sentinels(
        self, component_class, default_kwargs
    ):
    ...
    def test_load_files_empty_data_returns_empty_dataframe(
        self, component_class, default_kwargs
    ):
    ...
    def test_load_files_message_empty_data_returns_empty_message(
        self, component_class, default_kwargs
    ):
    ...
    def test_load_files_by_page_empty_data_returns_empty_dataframe(
        self, component_class, default_kwargs
    ):
    ...
    def test_load_files_by_page_pdf_format_returns_empty(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    @pytest.mark.asyncio
    async def test_read_pdf_tool_no_data_returns_message(
        self, component_class, default_kwargs, tmp_path
    ):
        """Test that read_pdf tool returns a message when no text is extracted."""
        component = component_class()
        component.set_attributes(
            {**default_kwargs, "path": [str(tmp_path / "test.pdf")]}
        )
    ...
    @pytest.mark.asyncio
    async def test_read_pdf_tool_returns_concatenated_text(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    @pytest.mark.asyncio
    async def test_read_pdf_tool_handles_exception(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    @pytest.mark.asyncio
    async def test_read_pdf_page_tool_returns_page_content(
        self, component_class, default_kwargs, tmp_path
    ):
        ...
        component = component_class()
        component.set_attributes(
            {**default_kwargs, "format": "text", "path": [pdf_file]}
        )
    ...
    @pytest.mark.asyncio
    async def test_read_pdf_page_tool_page_not_found(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    @pytest.mark.asyncio
    async def test_read_pdf_page_tool_no_pages_extracted(
        self, component_class, default_kwargs, tmp_path
    ):
        ...
        component = component_class()
        component.set_attributes(
            {**default_kwargs, "format": "pdf", "path": [pdf_file]}
        )
    ...
    @pytest.mark.asyncio
    async def test_read_pdf_page_tool_handles_exception(
        self, component_class, default_kwargs, tmp_path
    ):
        ...
        with patch.object(
            component, "_get_cached_data", side_effect=RuntimeError("Unexpected error")
        ):
            tools = await component._get_tools()
            result = await tools[1].ainvoke({"page_number": 1})
    ...
    def test_load_files_returns_expected_columns(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_compute_word_count_json_with_parsed_json(
        self, component_class, default_kwargs
    ):
    ...
    def test_compute_word_count_pdf_format_returns_zero(
        self, component_class, default_kwargs
    ):
    ...
    def test_compute_word_count_text_no_sentinels(
        self, component_class, default_kwargs
    ):
    ...
    def test_parse_pages_sentinel_total_pages_with_empty_trailing_page(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_parse_pages_from_json_malformed_json(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_parse_pages_from_json_kids_without_content(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_compute_word_count_markdown_with_html_format(
        self, component_class, default_kwargs
    ):
    ...
    def test_get_tool_description_with_path_objects(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_get_tool_description_with_none_in_path_list(
        self, component_class, default_kwargs
    ):
        """Test that get_tool_description skips None entries in path list."""
        component = component_class()
        component.set_attributes(
            {**default_kwargs, "path": [None, "flow123/valid.pdf"]}
        )
        desc = component.get_tool_description()
    ...
    def test_parse_pages_sentinel_no_preamble_unchanged(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_get_cached_page_data_calls_parse_once(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_cached_page_data_is_per_instance(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_description_property_setter_no_error(
        self, component_class, default_kwargs
    ):
    ...
    def test_get_tool_description_with_non_string_path(
        self, component_class, default_kwargs, tmp_path
    ):
        ...
        component = component_class()
        component.set_attributes(
            {**default_kwargs, "path": [PurePosixPath("/uploads/report.pdf")]}
        )
        desc = component.get_tool_description()
        assert "report.pdf" in desc

    def test_load_files_by_page_sets_status(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_file_path_as_list_single_data_object(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_file_path_as_list_none_returns_empty(
        self, component_class, default_kwargs
    ):
    ...
    def test_file_path_as_list_empty_list_returns_empty(
        self, component_class, default_kwargs
    ):
    ...
    def test_file_path_as_list_mixed_message_and_data(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_file_path_as_list_unsupported_type_delegates_to_super(
        self, component_class, default_kwargs
    ):
        ...
        with pytest.raises(ValueError, match="Expected list of Data"):
            component._file_path_as_list()

    # ------------------------------ load_files_message edge cases ---------------------

    def test_load_files_message_skips_empty_text(
        self, component_class, default_kwargs, tmp_path
    ):
        ...
        mock_data = [
            ...
            Data(
                data={"text": "Real content", "file_path": str(tmp_path / "good.pdf")}
            ),
        ]
        with patch.object(component, "_get_cached_data", return_value=mock_data):
            result = component.load_files_message()
    ...
    def test_parse_pages_from_json_missing_number_of_pages(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_description_property_delegates_to_get_tool_description(
        self, component_class, default_kwargs
    ):
    ...
    def test_process_files_html_format(
        self, _mock_java_check, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_parse_pages_from_sentinel_html(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_data_metadata_html_format(
        self, _mock_java_check, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_parse_pages_from_sentinel_markdown(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_parse_pages_from_sentinel_markdown_with_html(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_parse_pages_from_sentinel_markdown_with_images(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_count_total_pages_markdown_with_html_format(
        self, component_class, default_kwargs
    ):
    ...
    def test_count_total_pages_markdown_with_images_format(
        self, component_class, default_kwargs
    ):
    ...
    def test_compute_word_count_markdown_with_images_format(
        self, component_class, default_kwargs
    ):
    ...
    def test_count_total_pages_pdf_format_returns_one(
        self, component_class, default_kwargs
    ):
    ...
    def test_count_total_pages_pdf_format_explicit_fmt(
        self, component_class, default_kwargs
    ):
    ...
    def _make_component_with_cached_data(
        self, component_class, default_kwargs, fmt, mock_data
    ):
    ...
    def test_output_scenario_text_files(
        self, component_class, default_kwargs, tmp_path
    ):
        ...
        component = self._make_component_with_cached_data(
            component_class, default_kwargs, "text", mock_data
        )
    ...
    def test_output_scenario_text_pages(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_output_scenario_text_message(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_output_scenario_json_files(
        self, component_class, default_kwargs, tmp_path
    ):
        ...
        component = self._make_component_with_cached_data(
            component_class, default_kwargs, "json", mock_data
        )
        df = component.load_files()
    ...
    def test_output_scenario_json_pages(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_output_scenario_json_message(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_output_scenario_markdown_message_no_sentinel(
        self, component_class, default_kwargs, tmp_path
    ):
        ...
        component = self._make_component_with_cached_data(
            component_class, default_kwargs, "markdown", mock_data
        )
        msg = component.load_files_message()
    ...
    def test_output_scenario_html_message_no_sentinel(
        self, component_class, default_kwargs, tmp_path
    ):
        ...
        component = self._make_component_with_cached_data(
            component_class, default_kwargs, "html", mock_data
        )
        msg = component.load_files_message()
    ...
    def test_output_scenario_pdf_files(
        self, component_class, default_kwargs, tmp_path
    ):
        ...
        component = self._make_component_with_cached_data(
            component_class, default_kwargs, "pdf", mock_data
        )
        df = component.load_files()
    ...
    def test_output_scenario_pdf_pages_empty(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_output_scenario_pdf_message(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_output_scenario_multi_file_text_message(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_output_scenario_multi_file_pages(
        self, component_class, default_kwargs, tmp_path
    ):
    ...
    def test_image_dir_passed_when_set(
        self, _mock_java_check, component_class, default_kwargs, tmp_path
    ):
        ...
        component = component_class()
        component.set_attributes(
            {**default_kwargs, "image_dir": "/tmp/images", "image_output": "external"}
        )
        component.log = Mock()
        ...
        call_args = convert_calls[0]
        assert call_args["image_dir"] == "/tmp/images"

    @patch.object(
        OpenDataLoaderPDFComponent, "_check_java_installed", return_value=True
    )
    def test_image_dir_excluded_when_empty(
        self, _mock_java_check, component_class, default_kwargs, tmp_path
    ):
